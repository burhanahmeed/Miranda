...
public class HomeRecyclerCardViewAdapter extends RecyclerView.Adapter<HomeRecyclerCardViewAdapter.ItemRowHolder> {

    private ArrayList<HomeDataModel> dataList;
    private Context mContext;

    public HomeRecyclerCardViewAdapter(Context context, ArrayList<HomeDataModel> dataList) {
