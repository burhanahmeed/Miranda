...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    private String cond;       //String Resource for header view cond
    Context context;
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView,int ViewType,Context c) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if(ViewType == TYPE_ITEM) {
                ...
                cond = (TextView) itemView.findViewById(R.id.cond);       // Creating Text View object from header.xml for cond
    ...
    MyAdapter(String Titles[], int Icons[], String Name, String cond, int Profile, Context passedContext){ // MyAdapter Constructor with titles and icons parameter
        // titles, icons, name, cond, profile pic are passed from the main activity as we
